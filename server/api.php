...
// récupère la méthode d'envoie de la requète (Get, Post, ...)
$request_method = $_SERVER["REQUEST_METHOD"];

// Récuperation tu token passer par l'entête de la requète
...
switch($request_method) {
    case 'GET':
        ...
        if ($_GET['call'] == 'getToken'&& $token->checkjwtToken( $numeroToken ) ) {
            $result=  $token->checkjwtToken( $numeroToken );
