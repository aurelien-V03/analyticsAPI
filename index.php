        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
          ...
          <div class="row">
            ...
            <div class="col-lg-1 col-md-1 col-xs-1 col-sm-1">
              <label for="code_ecran"> code_ecran :</label>
              <input class="form-control" type="text" name="code_ecran" id="code_ecran">
            ...
            <div class="col-lg-1 col-md-1 col-xs-1 col-sm-1">
              <label for="code_action"> code_action:</label>
              <input class="form-control" type="text" name="code_action" id="code_action">
